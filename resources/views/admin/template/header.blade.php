<header class="container-header">
    <div class="header-top">
        <div class="d_flex al_ct jc_sb w100">
            <div class="logo-site">
                <a href="/" class="sidebar-header-link">
                    <img class="sidebar-header-img" src="{{ asset('images/home/logoweb.png') }}?v={{ time() }}" alt="Logo">
                </a>
            </div>
            <div class="header-menu">
                <div class="theme-toggle d_flex al_ct gap_10 mt_2">
                    <div class="theme-toggle-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" class="iconify iconify--system-uicons" width="24" height="24" preserveAspectRatio="xMidYMid meet" viewBox="0 0 21 21">
                    ...
                    <div class="box_input_toggle-dark">
                        <label class="m_label_toggle-dark">
                            <input class="m_input_toggle-dark" type="checkbox" name="toggle-dark" data="0" onchange="">
                            <span class="m_span_toggle-dark"></span>
                        </label>
                    </div>
                    <div class="theme-toggle-icon">
        ...
        <div class="ShowInforAccount">
            ...
            <div class="ShowInforAccount-content">
                <div class="account-content-header">
                    ...
                    <img onerror='this.onerror=null;this.src="/images/home/logoweberror.png";' src="/images/home/logoweberror.png" data-src="/images/home/logoweberror.png" class="lazyload account-avatar" alt="img">
                    </div>
