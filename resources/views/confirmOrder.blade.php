                            ...
                            <div class="confirmOrder">
                                ...
                                <div class="time_work">
                                    <div class="item item-confirm-address">
                                        <input type="radio" class="confirm-shipaddress" checked name="shipaddress" id="shipaddress" value="1">
                                        <p class="font_s15 line_h20 font_w500">Tên người nhận: <span class="font_s14 line_h20 font_w400 cl_000">Mạnh</span></p>
                                    ...
                                    <div class="item">
                                        ...
                                        <p class="font_s15 line_h20 font_w500">Số điện thoại: <span class="font_s14 line_h20 font_w400 cl_000">0123456789</span></p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="modal-content">
                    <div class="show_infor_ship">
                        <div class="item-infor-ship">
                            <div class="time_work">
                                <div class="item item-confirm-address">
                                    <input type="radio" class="confirm-shipaddress" checked name="confirm-shipaddress" id="confirm-shipaddress" value="1" onclick="SetShipDefalt(this)">
                                    <p class="font_s15 line_h20 font_w500">Tên người nhận: <span class="font_s14 line_h20 font_w400 cl_000">Mạnh</span></p>
                                    <div class="container-edit-inforship">
