...
class CreateAddressOrdersTable extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('address_orders', function (Blueprint $table) {
            ...
            // tên người liên hệ
            $table->string('address_orders_user_name')->default('NULL');
            // số điện thoại người liên hệ
            $table->string('address_orders_user_phone')->default('NULL');
             // email người liên hệ
             $table->string('address_orders_user_email')->default('NULL');
            // tỉnh/thành phố
            ...
            // địa chỉ chi tiết
            $table->string('address_orders_detail')->default('NULL');
            // đặt làm mặc định
